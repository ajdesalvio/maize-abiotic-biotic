...
# Import VI FPCs
fpc <- fread(paste0(data_path, '2021_Rust_FPC_Scores_VI_BLUEs.csv')) %>% as.data.frame()
...
#write_rds(elastic_all_results, file = paste0(data_path, 'RData/20250814_Elastic_Net_FPCs.rds'))
...
#fwrite(vip_df, paste0(data_path, '2021_Rust_Elastic_Net_FPCs_VarImp.csv'))
#fwrite(loeo_metrics_df, paste0(data_path, '2021_Rust_Elastic_Net_FPCs_Metrics.csv'))
