...
#fwrite(fpc_out_df, paste0(data_path, '2021_Rust_FPC_Scores_VI_BLUEs.csv'))
...
#fwrite(stack_out_df, paste0(data_path, '2021_Rust_FPCA_Predicted_Vals.csv'))

#save.image(paste0(data_path, 'RData/20250812_FPCA_VI_BLUEs_V1.RData'))