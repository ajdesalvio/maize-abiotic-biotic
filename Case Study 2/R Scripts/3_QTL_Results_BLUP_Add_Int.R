...
# Export CSV files
fwrite(scan1blup_results_wide, paste0(data_path, 'QTL.Results.BLUPs.Add.Int.wide.csv'))
fwrite(scan1blup_results_long, paste0(data_path, 'QTL.Results.BLUPs.Add.Int.long.csv'))
