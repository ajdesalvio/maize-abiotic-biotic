...
qtl <- read.csv(paste0(data_path, 'QTL.Results.LODPeaks.Add.Int.csv'))  # columns: chr, pos, model, LOD
...
#data.table::fwrite(candidate_df, paste0(data_path, 'QTL.Results.Gene.Hits.Add.Int.csv'))
