...
#fwrite(Lod_combined_long, paste0(data_path, 'QTL.Results.LOD.ByEnv.Delta.csv'))
#fwrite(perm_combined_long, paste0(data_path, 'QTL.Results.Perm.ByEnv.Delta.csv'))
#fwrite(lod_peaks_long, paste0(data_path, 'QTL.Results.LODPeaks.ByEnv.Delta.csv'))